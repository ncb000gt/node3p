...
function Node3p(saveRoot) {
  ...
  util.debug('Concurrent downloads limited to ' + this.MAX_DOWNLOADS + '.\n');
...
Node3p.prototype.finishedDownload = function(o) {
  util.puts('Downloaded: "'+o.title+'" by "'+o.primary+'" to "'+o.filename+'".');
...
Node3p.prototype.skipped = function(o, reason) {
  util.puts('Skipped download: "'+o.title+'" by "'+o.primary+'" to "'+o.filename+'". Reason: ' + reason);
  this.downloaded.push(o);
...
Node3p.prototype.endPrepare = function() {
  util.puts('No more files queued for download. Downloads may be finishing.');
};
